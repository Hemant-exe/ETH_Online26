...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-purple-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg border-0">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-base mt-1 text-gray-600">
            We encountered an issue with the onboarding process
          </CardDescription>
        </CardHeader>
